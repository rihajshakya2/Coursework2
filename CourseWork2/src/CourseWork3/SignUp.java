...
public class SignUp {
	...
	class Reg{
	    Reg(){
	        ...
	        ImageIcon background_image=new ImageIcon("C:\\Users\\Lenovo\\eclipse-workspace\\CourseWork2\\src\\CourseWork3\\signup.jpeg");
			...
			JLabel jreg=new JLabel("Bookstore Sign Up ");
			background.add(jreg);
